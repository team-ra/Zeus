...
#define LAUNCH_MOTOR_PORT 6
#define LIFT_MOTOR_PORT 18
#define WRIST_MOTOR_PORT 17
#define ELEVATION_MOTOR_PORT 7
#define BALL_INTAKE_MOTOR_PORT 2
#define RIGHT_DRIVE_MOTOR_2PORT 4
#define LEFT_DRIVE_MOTOR2_PORT 1
